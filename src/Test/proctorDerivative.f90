...
PRIVATE
    ...
    END TYPE proctor_d1f

CONTAINS

    SUBROUTINE destructor(this)
        TYPE(proctor_d1f) :: this

        ! WRITE(*,*) "[proctor_d1f] Deallocating dynamic arrays..."
